<%@ Page Language="C#" MasterPageFile="~/Add_Modules/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="4_Admin_YCI_Last_Job_CTC_Master.aspx.cs" Inherits="Add_Modules_Admin_Default"
    Title="YCI Last Job CTC Master" %>
                        ...
                        <ContentTemplate>
                            <div class="signin_contact1" style="text-align: left;">
                                <div style="text-align: center;">
                                    <b style="color: #DE0B1C">A</b>dd - <b style="color: #DE0B1C">L</b>ast <b style="color: #DE0B1C">J</b>ob <b style="color: #DE0B1C">C</b>TC
                                </div>
                                <div id="LAST_JOB_CTC_id" runat="server" visible="false">
                                    <br />
                                    <div class="contact_large_div">
                                        <p style="margin-left: 20px; font-size: 13px; margin-top: 20px;">
                                            LAST_JOB_CTC ID
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_LAST_JOB_CTC_id"
                                                ValidationGroup="req_LAST_JOB_CTC_detail" ErrorMessage="*" ForeColor="Red" Font-Bold="true"></asp:RequiredFieldValidator>
                                        </p>
                                    </div>
                                    <div class="contact_large_div">
                                        <asp:TextBox ID="txt_LAST_JOB_CTC_id" runat="server" CssClass="txt_style" Placeholder="Eg. 1"
                                ...
                                <div>
                                    ...
                                    <div class="contact_large_div">
                                        <p style="margin-left: 20px; font-size: 13px; margin-top: 20px;">
                                            Enter LAST_JOB_CTC
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_LAST_JOB_CTC_AMOUNT"
                                                ValidationGroup="req_LAST_JOB_CTC_detail" ErrorMessage="*" ForeColor="Red" Font-Bold="true"></asp:RequiredFieldValidator>
                                        </p>
                                    </div>
                                    <div class="contact_large_div">
                                        <p style="margin-left: 20px; font-size: 13px; margin-top: 7px;">
                                            <asp:TextBox ID="txt_LAST_JOB_CTC_AMOUNT" runat="server" CssClass="txt_style" Placeholder=""
                                ...
                                <div class="contact_large_div">
                                    <div style="width: 100%; height: 50px; margin-left: 20px; margin-top: 7px;">
                                        <asp:Button ID="btn_send" runat="server" Text="Send" CssClass="btn_style" ValidationGroup="req_LAST_JOB_CTC_detail"
                            ...
                            <div class="signin_contact2" style="background-image: none; border: 0px;">
                                ...
                                <div>
                                    <div style="text-align: center; color: Black; font-family: Arial Black; font-size: 14px;">
                                        <b style="color: #DE0B1C">M</b>odify - <b style="color: #DE0B1C">L</b>ast <b style="color: #DE0B1C">J</b>ob <b style="color: #DE0B1C">C</b>TC
                                    </div>
                                </div>
                                <div>
                                    <div>
                                        ...
                                        <div align="center" style="width: 100%;">
                                            <asp:GridView ID="grd_display_LAST_JOB_CTC" runat="server" AutoGenerateColumns="false"
                                                DataKeyNames="YCI_LAST_JOB_CTC_ID" Width="100%" AllowPaging="true" PageIndex="0"
                                                BorderColor="  #DE0B1C" BorderWidth="0px" PageSize="4" OnPageIndexChanging="grd_display_LAST_JOB_CTC_PageIndexChanging"
                                                OnRowDeleting="grd_display_LAST_JOB_CTC_RowDeleting" OnRowEditing="grd_display_LAST_JOB_CTC_RowEditing">
                                                <RowStyle BackColor="" Font-Size="12pt" ForeColor="#1F232F" HorizontalAlign="Center"
                                                    VerticalAlign="Middle" Height="45px" />
                                                <Columns>
                                                    <asp:BoundField DataField="YCI_LAST_JOB_CTC_AMOUNT" HeaderText="YCI | Last Job CTC" />
